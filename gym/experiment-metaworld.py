...
from decision_transformer.models.decision_transformer import DecisionTransformer, SoftPromptDecisionTransformer
...
def experiment(
    ...
    # data_loader = cycle(create_dataloader(
    ...
    # elif model_type == 'dif':
    #     model = DecisionDiffusionTransformer(
    #         state_dim=state_dim,
    #         act_dim=act_dim,
    #         max_length=K,
    #         max_ep_len=max_ep_len,
    ...
    #     diffusion = create_diffusion(timestep_respacing="", diffusion_steps=32, learn_sigma=False,)
    elif model_type == 'bc':
        model = MLPBCModel(
            state_dim=state_dim,
            act_dim=act_dim,
