...
do
    python experiment-offline.py  --env $var --tuning_type prompt --batch_size 64 --model_path $model_path --stochastic_policy --num_steps_per_iter 5000 --save_path "saved_model/ML45_prompt_tuning/" --eval_interval 10
done