...
class SawyerPickPlaceEnvV2(SawyerXYZEnv):
    ...
    def viewer_setup(self):
        ...
        self.viewer.cam.elevation = -30           # camera rotation around the axis in the plane going through the frame origin (if 0 you just see a line)
        self.viewer.cam.azimuth = 279              # camera rotation around the camera's vertical axis
